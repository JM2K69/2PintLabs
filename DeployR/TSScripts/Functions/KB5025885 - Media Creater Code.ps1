$WIMs = Get-ChildItem -Path C:\_2P\content -Filter *.wim | Select-Object Name, FullName | Where-Object FullName -NotMatch "00000003-0000-0000-0000-000000000001"
Write-Host "WIMs Found:" $WIMs

if ($WIMs.Count -eq 0){
    Write-Output "No WIMs Found in C:\_2P\content"
    exit 1
}
if ($WIMs.Count -gt 1){
    Write-Output "Multiple WIMs Found in C:\_2P\content"
    exit 2
}

$WinPEPath = $WIMs[0].FullName
...
#Map Network Drive
net use G: \\src.2p.garytown.com\2023Output$ /USER 2p\drts P@ssw0rd
