...
function Move-StifleRNetworkToNewGroup {
    <#
    Move a network to a new network group, creating a new location if needed.
    Inputs: 
    $NetworkIdToMove - The ID of the network to move
    $LocationName - The name of the new location
    $LocationDescription - The description of the new location
